...
namespace TNUE_Patron_Excel.Z303
{
	internal class z304
	{
		public string tab4(Patron p)
		{
            ...
            stringBuilder.Append(new ToolP().WriteStringCheckNull(p.DiaChi, "z304-address-1"));
            stringBuilder.Append(new ToolP().WriteStringCheckNull(p.QuocTich, "z304-address-2"));
   ...
   //         stringBuilder.Append("<z304-address-1>" + p.DiaChi + "</z304-address-1>");
            ...
            stringBuilder.Append(new ToolP().WriteStringCheckNull(p.email, "z304-email-address"));
            stringBuilder.Append(new ToolP().WriteStringCheckNull(p.phone, "z304-telephone"));
